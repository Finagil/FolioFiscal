...
Namespace FinagilDSTableAdapters
    ...
    Partial Public Class HistoriaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Historia] ([Documento], [Serie], [Numero], [Fecha], [Anexo], ["& _ 
                "Letra], [Importe], [Banco], [Cheque], [Observa1], [Balance], [Minds], [FolioFisc"& _ 
                "al]) VALUES (@Documento, @Serie, @Numero, @Fecha, @Anexo, @Letra, @Importe, @Ban"& _ 
                "co, @Cheque, @Observa1, @Balance, @Minds, @FolioFiscal)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Documento, Serie, Numero, Fecha, Anexo, Letra, Importe, Banco, Cheque, Obs"& _ 
                "erva1, Balance, Minds, FolioFiscal FROM dbo.Historia"
